              ...
              <article className="case-study">
                ...
                <div className="case-body">
                  ...
                  <div className="case-section">
                    ...
                    <p>
                      <strong>Cross-sector:</strong> The coverage universe
                      spans Technology, Energy, Real Estate, Healthcare, and
                      Consumer Staples intentionally, to surface operating
                      model differences rather than just rank similar
                      businesses.
                    </p>
                    <p>
                      <strong>Anchored:</strong> Scenario deltas are applied
                      on top of each company&apos;s actual trailing numbers,
                      not arbitrary assumptions. Every projection traces back
                      to reported financials.
                    </p>
                    <p>
                      <strong>Parameterized:</strong> All tickers, scenario
                      assumptions, thresholds, and API settings live in a
                      single config file. Adding a company or changing an
                      assumption requires editing one line.
                    </p>
                    <p>
                      <strong>Reproducible:</strong> The dashboard refreshes
                      automatically when underlying data changes. One command,
                      under 60 seconds, no manual formatting or copy-pasting.
                    </p>
                  </div>
